...
//   useEffect(() => {
//     if (chatRef.current && !isLoadingMore) {
...
//   const handleScroll = () => {
//     if (chatRef.current && chatRef.current.scrollTop === 0 && !isLoadingMore) {
//       setIsLoadingMore(true);
//       setTimeout(() => {
//         setPage((prevPage) => prevPage + 1);
//         setIsLoadingMore(false);
//       }, 500); // Simulating a delay in loading more messages
//     }
//   };
...
export default function Chat() {
  ...
  useEffect(() => {
    setHasMoreMessages(messages.length > page * PAGE_SIZE);
  }, [messages, page]);
